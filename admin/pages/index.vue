...
<a href="#" class="a-button-history margin-right-10" @click.prevent="redirectToHome()">Home</a>
...
export default {
  //asyncData is fetching data before nuxt page finishes loading on browser
  //it is good for seo because the data loaded first
