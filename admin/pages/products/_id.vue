...
let categories= $axios.$get('http://localhost:4000/api/categories');
    ...
    let product= $axios.$get(`http://localhost:4000/api/products/${params.id}`);
  ...
  methods: {
    ...
    async onUpdateProduct(){
      ...
      let result=await this.$axios.$put(`http://localhost:4000/api/products/${this.$route.params.id}`,data);
      this.$router.push("/");
    }
  }
