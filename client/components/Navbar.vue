    ...
    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 pl-2">
      <div class="nav-global-location">
        ...
        <div id="glow-ingress-block">
          ...
          <span class="nav-line-2" id="glow-ingress-line-2">{{$auth.$state.user.address.city}}</span>
        </div>
        </nuxt-link>
      </div>
    </div>
...
<div class="nav-tools">
  ...
  <template v-if="$auth.$state.loggedIn">
    <nuxt-link to="/profile" class="nav-a nav-a-2" id="nav-link-accountList" tabindex="0"> <span class="nav-line-1">Hello,</span>
    <span class="nav-line-2">
